...
class SmartSignalPipeline:
    ...
    def _stage_train(self, panel: pd.DataFrame):
        ...
        from smartsignal.validation.walk_forward import (
            WalkForwardSplitter, run_walk_forward
        )
        ...
        panel_scored = run_walk_forward(
            panel, model, FEATURE_COLS,
            splitter=splitter,
            verbose=self.verbose,
        )
    ...
    def _stage_backtest(
        ...
        return run_backtest(
            ...
            min_universe_size = max(self.n_long + self.n_short + 5, 10),
